...
exports.getProducts = (req, res, next) => {
  ...
  if (req.query.search?.prices) {
    req.query.search.currentPrice = { $gt: Number(req.query.search.prices[0]), $lt: Number(req.query.search.prices[1]) }
    delete req.query.search.prices;
  }
